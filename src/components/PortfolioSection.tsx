  ...
  return (
    ...
    >
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-8 sm:gap-10 md:gap-16 lg:gap-24 xl:gap-32 overflow-hidden">
          {/* Left Column */}
          <div className="col-span-1 sm:col-span-1 md:col-span-6 lg:col-span-5 flex flex-col gap-8 sm:gap-12 md:gap-32 lg:gap-48 xl:gap-56">
            <PortfolioCard
              project={projects[0]}
          ...
          <div className="col-span-1 sm:col-span-1 md:col-span-6 lg:col-span-5 lg:col-start-8 flex flex-col gap-8 sm:gap-12 md:gap-32 lg:gap-48 xl:gap-56 md:mt-32 lg:mt-48 xl:mt-64">
            <PortfolioCard
              project={projects[1]}
            ...
            <PortfolioCard
              ...
              delay="0.4s"
              aspectRatio="4/5"
              className="md:w-[90%] lg:w-3/4 lg:-ml-12 xl:-ml-20"
            />
