...
export function MagneticText({ text = "CREATIVE", hoverText, className, circleSize = 320 }: MagneticTextProps) {
  ...
  return (
    ...
    >
      {/* Base text layer - dim */}
      <span
        className="text-4xl sm:text-5xl md:text-7xl lg:text-9xl font-bold tracking-tighter"
      ...
      >
        ...
        >
          <span
            ref={innerTextRef}
            className="text-4xl sm:text-5xl md:text-7xl lg:text-9xl font-bold tracking-tighter whitespace-nowrap"
            style={{ 
              color: "#000000",
              willChange: "transform",
            }}
