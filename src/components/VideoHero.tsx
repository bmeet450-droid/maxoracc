...
const VideoHero = () => {
  ...
  return (
    ...
    >
      ...
      {/* Scroll indicator */}
      <div 
        className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 transition-all duration-700 z-20 md:hidden" 
        style={{
      ...
      {/* Corner Accents */}
      <div
        className="absolute top-24 left-8 w-12 h-12 pointer-events-none hidden md:block z-20"
        style={{
      ...
      />
      <div
        className="absolute top-24 right-8 w-12 h-12 pointer-events-none hidden md:block z-20"
        style={{
