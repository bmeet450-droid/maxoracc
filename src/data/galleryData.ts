...
import human1 from "@/assets/gallery/the-human-frame/DSC01765.jpg";
import human2 from "@/assets/gallery/the-human-frame/DSC01768.jpg";
import human3 from "@/assets/gallery/the-human-frame/portrait-profile.jpg";
import human4 from "@/assets/gallery/the-human-frame/couple-station.jpg";
import human5 from "@/assets/gallery/the-human-frame/street-vendor.jpg";
...
export const galleryData: Record<string, GalleryImage[]> = {
  ...
  "the-human-frame": [
    { id: 1, src: human1, alt: "Smiling woman with colorful scarf in snow", aspectRatio: "3/4" },
    { id: 2, src: human2, alt: "Man with MTA beanie smiling in winter", aspectRatio: "3/4" },
    { id: 3, src: human3, alt: "Portrait profile with bokeh lights", aspectRatio: "3/4" },
    { id: 4, src: human4, alt: "Couple at train station", aspectRatio: "3/4" },
    { id: 5, src: human5, alt: "Street vendor with crafts", aspectRatio: "16/9" },
  ],
